...
order = 3
OSR = 10
nlev = 15        ## 4-bit quantizer
form = 'CRFF'   ## FF better for highly linear OpA 
...
if noise_in_type == 1: ## Split Input and DAC CAP structure
    ...
    sigma2_dac_in = 0
    sigma2_sw_in = 2 * (2*nlev -2 +2) * 4e-21 * 0.38 / Cin          # 0.38 factor from the integrated sinc^2
