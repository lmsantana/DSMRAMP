...
#            y01int = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) -(vbm11+vbm21+vbm31+vbm41)+opt_g2*2*(vbm12+vbm22+vbm32+vbm42)
            y01int = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) ## mid conversion coupling signal
            y1[:,i] = y01int
            yz1 = y01int
            
            vb51 = ds_quantize(y01int                                      ,2)*32.0
            vb41 = ds_quantize((y01int-vb51)                               ,2)*16.0
            vb31 = ds_quantize((y01int-vb51-vb41)                          ,2)*8.0
            vb21 = ds_quantize((y01int-vb51-vb41-vb31)                     ,2)*4.0
            vb11 = ds_quantize((y01int-vb51-vb41-vb31-vb21)                ,2)*2.0
            y01int = y01int -(vbm11+vbm21+vbm31+vbm41)+opt_g2*2*(vbm12+vbm22+vbm32+vbm42)
            vb01 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11)           ,2)*1.0
            vb01r1 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01)    ,2)*1.0
            vb01r2 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01-vb01r1)  ,2)*1.0
                               
            # eq1 digital approximation
            vbm11 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01-vb01r1-vb01r2)*att_shr                ,2)*0.5
            vbm21 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01-vb01r1-vb01r2-vbm11)*att_shr          ,2)*0.25
            vbm31 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01-vb01r1-vb01r2-vbm11-vbm21)*att_shr    ,2)*0.125
            vbm41 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01-vb01r1-vb01r2-vbm11-vbm21-vbm31)*att_shr,2)*0.0625
                                
            vdac1 = vb51+vb41+vb31+vb21+vb11+vb01+vb01r1+vb01r2
...
#            y02int = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) -(vbm12+vbm22+vbm32+vbm42)+opt_g2*2*(vbm11+vbm21+vbm31+vbm41)
            y02int = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) ## mid conversion coupling signal
            y2[:,i] = y02int
            yz2 = y02int
            
            vb52 = ds_quantize(y02int                                      ,2)*32.0
            vb42 = ds_quantize((y02int-vb52)                               ,2)*16.0
            vb32 = ds_quantize((y02int-vb52-vb42)                          ,2)*8.0
            vb22 = ds_quantize((y02int-vb52-vb42-vb32)                     ,2)*4.0
            vb12 = ds_quantize((y02int-vb52-vb42-vb32-vb22)                ,2)*2.0
            y02int = y02int -(vbm12+vbm22+vbm32+vbm42)+opt_g2*2*(vbm11+vbm21+vbm31+vbm41)
            vb02 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12)           ,2)*1.0
            vb02r1 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02)    ,2)*1.0
            vb02r2 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02-vb02r1)  ,2)*1.0
                               
            # eq2 digital approximation
            vbm12 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02-vb02r1-vb02r2)*att_shr                ,2)*0.5
            vbm22 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02-vb02r1-vb02r2-vbm12)*att_shr          ,2)*0.25
            vbm32 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02-vb02r1-vb02r2-vbm12-vbm22)*att_shr    ,2)*0.125
            vbm42 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02-vb02r1-vb02r2-vbm12-vbm22-vbm32)*att_shr,2)*0.0625
            
            vdac2 = vb52+vb42+vb32+vb22+vb12+vb02+vb02r1+vb02r2
