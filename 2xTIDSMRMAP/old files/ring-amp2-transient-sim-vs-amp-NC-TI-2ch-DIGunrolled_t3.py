...
#            y01 = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) - (yz1-vdac1) + 2*(yz2-vdac2)
            y01int = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) - (yz1-vdac1)
            y1[:,i] = y01int
...
#            y02 = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) - (yz2-vdac2) + 2*(yz1-vdac1)
            y02int = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) - (yz2-vdac2)
            y2[:,i] = y02int
