...
#            y01 = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) - (yz1-vdac1) + 2*(yz2-vdac2)
            y01int = np.real(np.dot(C, x01) + np.dot(D1, u[:,i])) - (yz1-vdac1) -2*(yz2p-vdac2p + 2*(eq01p))
            y1[:,i] = y01int
            
            yz2p = yz2
            vdac2p = vdac2
            eq02p = eq02
            eq02 = yz2p-vdac2p + 2*(eq01)
...
#            vb11 = ds_quantize((y01int-vb51-vb41-vb31-vb21+2*(eq02)),8)*1.0
#            vdac1 = vb51+vb41+vb31+vb21+vb11
...
#            vbred1 = ds_quantize((y01int-vb51-vb41-vb31-vb21-vb11-vb01+2*eq02),3)*1.0
            vbred1 = ds_quantize((y01int*0.0 + 2*eq02),5)*1.0
            vdac1 = vb51+vb41+vb31+vb21+vb11+vb01+vbred1
...
#            y02 = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) - (yz2-vdac2) + 2*(yz1-vdac1)
            y02int = np.real(np.dot(C, x02) + np.dot(D1, u[:,i])) - (yz2-vdac2) -2*(yz1p-vdac1p + 2*(eq02p))
            y2[:,i] = y02int
            
            yz1p = yz1
            vdac1p = vdac1
            eq01p = eq01
            eq01 = yz1p-vdac1p + 2*(eq02)
...
#            vb12 = ds_quantize((y02int-vb52-vb42-vb32-vb22+2*(eq01)),8)*1.0
#            vdac2 = vb52+vb42+vb32+vb22+vb12
...
#            vbred2 = ds_quantize((y02int-vb52-vb42-vb32-vb22-vb12-vb02+2*eq01),3)*1.0
            vbred2 = ds_quantize((y02int*0.0 + 2*eq01),5)*1.0
            vdac2 = vb52+vb42+vb32+vb22+vb12+vb02+vbred2
            
            yz2 = y02int
            
#            vdac2 = ds.ds_quantize(y02,nlev)
